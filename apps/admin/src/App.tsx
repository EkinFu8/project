    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b border-border bg-secondary/50 px-6 py-4">
        <div className="mx-auto flex max-w-4xl items-center justify-between">
          <h1 className="text-xl font-bold tracking-tight">myapp admin</h1>
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <div className="space-y-12">
          ...
          <section className="text-center space-y-4">
            <h2 className="text-4xl font-bold tracking-tight">{capitalize("admin")} Dashboard</h2>
          ...
          <section className="rounded-xl border border-border p-6 space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <StatusCard label="Vite + React" status="ok" detail="Admin frontend running" />
              <StatusCard label="Tailwind v4" status="ok" detail="Shared theme applied" />
          ...
          {/* Interactive demo */}
          <section className="rounded-xl border border-border p-6 space-y-4">
            <h3 className="text-lg font-semibold">Admin Controls Demo</h3>
            <p className="text-muted-foreground">
              Same shared Button from{" "}
              <code className="rounded bg-muted px-1.5 py-0.5 text-sm">@myapp/ui</code> — consistent
              styling across both apps
            </p>
      ...
      <footer className="border-t border-border px-6 py-4 text-center text-sm text-muted-foreground">
        myapp admin &middot; Vite + React + tRPC + Supabase + Tailwind v4
      </footer>
    </div>
  );
}
