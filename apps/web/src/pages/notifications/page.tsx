...
export function NotificationsView() {
  ...
  if (list.isError) {
    return (
      <div className="rounded border border-border bg-card p-6 text-card-foreground shadow-sm">
        <p className="font-medium text-red-600">Could not load notification data.</p>
  ...
  return (
    <div className="overflow-x-auto rounded-lg border border-border bg-card shadow-sm transition-shadow duration-200 hover:shadow-md">
      {rows.length === 0 ? (
