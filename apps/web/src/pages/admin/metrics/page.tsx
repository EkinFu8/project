      ...
      <div>
        ...
        <div className="border rounded-lg bg-background">
          {auditRecent.data?.slice(0, 10).map((a) => (
            <div key={a.id} className="flex justify-between p-3 border-b text-sm">
              <span>{a.action}</span>
              <span className="text-muted-foreground">{a.fileName ?? "N/A"}</span>
      ...
      <div>
        ...
        <div className="border rounded-lg bg-background">
          {recentMetrics.data?.slice(0, 10).map((r) => (
            <div key={r.id} className="flex justify-between p-3 border-b text-sm">
              <span>{r.route}</span>
